...
class VM:
  ...
  def __init__(self, rom):
    ...
    self.stack_prime = [18181, 17971, 17471, 16661, 16561, 16361, 16061, 15551, 15451, 14741, 14341, 13931, 13831, 13331, 12821, 12721, 12421, 11411, 11311, 10601, 10501, 10301, 929, 919, 797, 787, 757, 727, 383, 373, 353, 313, 191, 181, 151, 131, 101, 11, 7, 5, 3]
